...
//             <h1 className="text-3xl sm:text-4xl font-semibold text-white mt-6">
...
//                     <div
//                         key={index}
//                         className="flex items-center bg-white/10 backdrop-blur-md bg-opacity-10 shadow-lg   rounded-xl p-6 space-x-4 border border-white/20"
//                     >

//                         <div
//                             className="w-16 h-16 rounded-lg overflow-hidden"
//                             style={{ backgroundColor: "#011A30" }}
//                         >
...
//                             {firm.reviews && (
//                                 <p className="text-gray-400 text-xs mt-1">{firm.reviews}</p>
//                             )}
//                         </div>
...
//             <button className="mt-8 px-6 py-3 text-lg font-medium text-blue-600 border border-blue-600 rounded-full hover:bg-blue-600 hover:text-white transition">
//                 See All
//             </button>
//         </div>
//     );
...
//                     <div
//                         key={index}
//                         className="flex items-center bg-gradient-to-r from-blue-900 to-blue-950 shadow-lg rounded-xl p-6 space-x-6 border border-white/20"
//                     >
//                         {/* Firm Logo */}
//                         <div className="w-20 h-20 rounded-lg overflow-hidden bg-[#011A30] flex-shrink-0">
//                             <img src={firm.logo} alt={firm.name} className="w-full h-full object-cover" />
//                         </div>
...
//                             {/* Features List */}
//                             <div className="mt-2 text-gray-400 text-sm flex flex-col space-y-1">
//                                 <p>✅ Feature 1</p>
//                                 <p>✅ Feature 2</p>
//                             </div>
...
//                                 <div>
//                                     <p className="uppercase text-gray-400">Avg. Payout Time</p>
//                                     <p className="text-white font-semibold">{firm.payoutTime}</p>
//                                 </div>
//                                 <div>
//                                     <p className="uppercase text-gray-400">Profit Payout</p>
//                                     <p className="text-white font-semibold">{firm.profitPayout}</p>
//                                 </div>
//                                 <div>
//                                     <p className="uppercase text-gray-400">Trading Platforms</p>
//                                     <p className="text-white font-semibold">{firm.platforms}</p>
//                                 </div>
//                             </div>
//                         </div>
...
//                                 <StarRating rating={firm.rating} />
//                             </div>
//                             <p className="text-gray-400 text-xs">{firm.reviews} Total Reviews</p>
